...
public class CopyArray2 {
	public static void main(String args[]) { 
		...
		String str4 = "Universitas Syiah Kuala"; String 
		str5 = "universitas syiah kuala"; 
...
/* 
Code dari program diatas untuk menentukan apakah string tersebut memiliki teks yang sama atau tidak, 
caranya membandingkan satu string dengan yang lainnya. 
*/
